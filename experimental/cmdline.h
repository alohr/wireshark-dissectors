...
#define CMDLINE_PARSER_PACKAGE "beacon"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "beacon"
#endif
...
struct gengetopt_args_info
{
  ...
  int count_arg;	/**< @brief stop after n packets (default='-1').  */
  char * count_orig;	/**< @brief stop after n packets original value given at command line.  */
  const char *count_help; /**< @brief stop after n packets help description.  */
  int delay_arg;	/**< @brief delay between packets (default='100').  */
  char * delay_orig;	/**< @brief delay between packets original value given at command line.  */
  const char *delay_help; /**< @brief delay between packets help description.  */
